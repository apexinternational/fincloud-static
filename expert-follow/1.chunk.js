...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__apex_services_competition_service__ = __webpack_require__(640);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__competition_page_component__ = __webpack_require__(1490);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__app_rank_app_rank_competition_component__ = __webpack_require__(1441);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__app_detailed_app_detailed_competition_component__ = __webpack_require__(1437);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__competitions_competitions_component__ = __webpack_require__(1491);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__my_competition_my_competition_component__ = __webpack_require__(1492);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__competition_page_routing__ = __webpack_require__(1535);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__shared_shared_module__ = __webpack_require__(262);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__app_participate_app_participate_competition_component__ = __webpack_require__(1440);
    ...
    CompetitionPageModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_12__competition_page_routing__["a" /* routing */]
            ],
            declarations: [
                __WEBPACK_IMPORTED_MODULE_7__competition_page_component__["a" /* CompetitionPageComponent */],
                __WEBPACK_IMPORTED_MODULE_9__app_detailed_app_detailed_competition_component__["a" /* DetailedCompetitionComponent */],
                __WEBPACK_IMPORTED_MODULE_10__competitions_competitions_component__["a" /* CompetitionsComponent */],
                __WEBPACK_IMPORTED_MODULE_11__my_competition_my_competition_component__["a" /* MyCompetitionComponent */],
                __WEBPACK_IMPORTED_MODULE_14__app_participate_app_participate_competition_component__["a" /* ParticipateCompetitionComponent */],
                __WEBPACK_IMPORTED_MODULE_8__app_rank_app_rank_competition_component__["a" /* RankCompeteComponent */]
            ],
            bootstrap: [
                __WEBPACK_IMPORTED_MODULE_7__competition_page_component__["a" /* CompetitionPageComponent */]
            ],
            ...
            providers: [
                __WEBPACK_IMPORTED_MODULE_6__apex_services_competition_service__["a" /* CompetitionService */]
            ]
        })
...
//# sourceMappingURL=competition-page.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__apex_objects_competition__ = __webpack_require__(649);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__apex_services_competition_service__ = __webpack_require__(640);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_participate_app_participate_competition_component__ = __webpack_require__(1440);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DetailedCompetitionComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DetailedCompetitionComponent = /** @class */ (function () {
    function DetailedCompetitionComponent(activeModal, modalService, competitionSvc) {
        this.activeModal = activeModal;
        this.modalService = modalService;
        this.competitionSvc = competitionSvc;
    }
    DetailedCompetitionComponent.prototype.ngOnChanges = function () {
        if (this.competition.participate.length <= 0 || this.competition.awards.length <= 0) {
            this.modalService.open('此競賽尚在建置', { size: 'lg' });
            // FIXME: hard code of wording.
        }
    };
    DetailedCompetitionComponent.prototype.onParticipateCompetition = function (competition) {
        var _this = this;
        this.competitionSvc.participate(competition).subscribe(function (result) { });
        this.competitionSvc.realParticipate().subscribe(function (result) {
            if (result === 'success') {
                var modalRef = _this.modalService.open(__WEBPACK_IMPORTED_MODULE_4__app_participate_app_participate_competition_component__["a" /* ParticipateCompetitionComponent */], { size: 'lg' });
                modalRef.componentInstance.popupdetail = 'success';
            }
            else if (result === 'false') {
                var modalRef = _this.modalService.open(__WEBPACK_IMPORTED_MODULE_4__app_participate_app_participate_competition_component__["a" /* ParticipateCompetitionComponent */], { size: 'lg' });
                modalRef.componentInstance.popupdetail = 'false';
            }
            else if (result === 'full') {
                var modalRef = _this.modalService.open(__WEBPACK_IMPORTED_MODULE_4__app_participate_app_participate_competition_component__["a" /* ParticipateCompetitionComponent */], { size: 'lg' });
                modalRef.componentInstance.popupdetail = 'full';
            }
        });
    };
    DetailedCompetitionComponent.prototype.onCancelCompetition = function (competition) {
        this.competitionSvc.cancel(competition);
        location.reload();
    };
    DetailedCompetitionComponent.prototype.isParticipated = function (competition) {
        return this.competitionSvc.isParticipated(competition);
    };
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Input"])(),
        __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__apex_objects_competition__["a" /* Competition */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__apex_objects_competition__["a" /* Competition */]) === "function" && _a || Object)
    ], DetailedCompetitionComponent.prototype, "competition", void 0);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Input"])(),
        __metadata("design:type", String)
    ], DetailedCompetitionComponent.prototype, "position", void 0);
    DetailedCompetitionComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Component"])({
            selector: 'app-detailed-compete',
            template: __webpack_require__(1615),
            styles: [__webpack_require__(1555)],
        }),
        __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__ng_bootstrap_ng_bootstrap__["c" /* NgbActiveModal */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__ng_bootstrap_ng_bootstrap__["c" /* NgbActiveModal */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_0__ng_bootstrap_ng_bootstrap__["b" /* NgbModal */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__ng_bootstrap_ng_bootstrap__["b" /* NgbModal */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__apex_services_competition_service__["a" /* CompetitionService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__apex_services_competition_service__["a" /* CompetitionService */]) === "function" && _d || Object])
    ], DetailedCompetitionComponent);
    return DetailedCompetitionComponent;
    var _a, _b, _c, _d;
}());

//# sourceMappingURL=app-detailed-competition.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__apex_services_competition_service__ = __webpack_require__(640);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ParticipateCompetitionComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ParticipateCompetitionComponent = /** @class */ (function () {
    function ParticipateCompetitionComponent(activeModal, modalService, competitionSvc) {
        this.activeModal = activeModal;
        this.modalService = modalService;
        this.competitionSvc = competitionSvc;
    }
    __decorate([
        ...
        __metadata("design:type", String)
    ], ParticipateCompetitionComponent.prototype, "popupdetail", void 0);
    ParticipateCompetitionComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Component"])({
            selector: 'app-participate-compete',
            template: __webpack_require__(1616),
            styles: [__webpack_require__(1556)],
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__ng_bootstrap_ng_bootstrap__["c" /* NgbActiveModal */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__ng_bootstrap_ng_bootstrap__["c" /* NgbActiveModal */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__ng_bootstrap_ng_bootstrap__["b" /* NgbModal */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__ng_bootstrap_ng_bootstrap__["b" /* NgbModal */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__apex_services_competition_service__["a" /* CompetitionService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__apex_services_competition_service__["a" /* CompetitionService */]) === "function" && _c || Object])
    ], ParticipateCompetitionComponent);
    return ParticipateCompetitionComponent;
    var _a, _b, _c;
}());

//# sourceMappingURL=app-participate-competition.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__apex_objects_competition__ = __webpack_require__(649);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__(0);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RankCompeteComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RankCompeteComponent = /** @class */ (function () {
    function RankCompeteComponent(activeModal, modalService) {
        this.activeModal = activeModal;
        this.modalService = modalService;
    }
    RankCompeteComponent.prototype.ngOnChanges = function () {
        if (this.competition.participate.length <= 0 || this.competition.awards.length <= 0) {
            this.modalService.open('此競賽尚在建置', { size: 'lg' });
            // FIXME: hard code of wording.
        }
    ...
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Input"])(),
        __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__apex_objects_competition__["a" /* Competition */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__apex_objects_competition__["a" /* Competition */]) === "function" && _a || Object)
    ], RankCompeteComponent.prototype, "competition", void 0);
    RankCompeteComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Component"])({
            selector: 'app-rank-compete',
            template: __webpack_require__(1617),
            styles: [__webpack_require__(1557)],
        }),
        __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__ng_bootstrap_ng_bootstrap__["c" /* NgbActiveModal */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__ng_bootstrap_ng_bootstrap__["c" /* NgbActiveModal */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_0__ng_bootstrap_ng_bootstrap__["b" /* NgbModal */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__ng_bootstrap_ng_bootstrap__["b" /* NgbModal */]) === "function" && _c || Object])
    ], RankCompeteComponent);
    return RankCompeteComponent;
    var _a, _b, _c;
}());

//# sourceMappingURL=app-rank-competition.component.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_date_fns__ = __webpack_require__(263);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_date_fns___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_date_fns__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_Subject__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_Subject___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_Subject__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ng_bootstrap_ng_bootstrap__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__apex_services_competition_service__ = __webpack_require__(640);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_rank_app_rank_competition_component__ = __webpack_require__(1441);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__app_detailed_app_detailed_competition_component__ = __webpack_require__(1437);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CompetitionPageComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CompetitionPageComponent = /** @class */ (function () {
    function CompetitionPageComponent(modalService, competeService, modal) {
        this.modalService = modalService;
        this.competeService = competeService;
        this.modal = modal;
        this.selectedCompetitions = [];
        this.joinCalendarflag = false;
        this.joinCalendarflagdate = false;
        this.view = 'month';
    ...
    CompetitionPageComponent.prototype.getCompete = function () {
        var _this = this;
        this.competeService.getCompetitions().subscribe(function (competes) { return _this.competitions = competes; });
    };
    CompetitionPageComponent.prototype.ngOnInit = function () {
        this.getCompete();
    };
    // for Detail
    CompetitionPageComponent.prototype.onSelectCompetition = function (competition) {
        var modalRef = this.modalService.open(__WEBPACK_IMPORTED_MODULE_6__app_detailed_app_detailed_competition_component__["a" /* DetailedCompetitionComponent */], { size: 'lg' });
        modalRef.componentInstance.competition = competition;
    };
    // for Rank
    CompetitionPageComponent.prototype.onSelectRank = function (competition) {
        var modalRef = this.modalService.open(__WEBPACK_IMPORTED_MODULE_5__app_rank_app_rank_competition_component__["a" /* RankCompeteComponent */], { size: 'lg' });
        modalRef.componentInstance.competition = competition;
    };
    // for Participate
    CompetitionPageComponent.prototype.onParticipate = function (competition) {
        this.selectedCompetition = competition;
        this.modalService.open('您已成功報名課程');
        // FIXME: hard code of wording.
        if (this.selectedCompetitions.indexOf(competition) === -1) {
            this.selectedCompetitions.push(this.selectedCompetition);
            this.joinCalendarflag = true;
        }
        else {
            this.joinCalendarflag = false;
        }
    ...
    // for cancel
    CompetitionPageComponent.prototype.onCancel = function (competition) {
        var index = this.selectedCompetitions.indexOf(competition);
        this.selectedCompetitions.splice(index, 1);
        if (this.joinCalendarflagdate === true) {
        ...
        this.refresh.next();
        this.modalService.open('您已取消報名成功');
        // FIXME: hard code of wording.
    };
    // add compete value to calendar
    CompetitionPageComponent.prototype.addEvent = function (competition) {
        this.selectedCompetition = competition;
        if (this.joinCalendarflag === true) {
            if (Array.isArray(this.selectedCompetition.startDate) === true) {
                if (this.selectedCompetition.startDate.length <= 0) {
                    this.events.push({
                        title: this.selectedCompetition.name,
                        start: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_date_fns__["startOfDay"])(new Date(this.selectedCompetition.startDate)),
                        end: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_date_fns__["endOfDay"])(new Date(this.selectedCompetition.endDate)),
                        color: colors.red,
                        draggable: true,
                        resizable: {
                            beforeStart: true,
                ...
                else if (this.selectedCompetition.startDate.length > 1) {
                    for (var i = 0; i < this.selectedCompetition.startDate.length; i++) {
                        this.events.push({
                            title: this.selectedCompetition.name,
                            start: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_date_fns__["startOfDay"])(new Date(this.selectedCompetition.startDate[i])),
                            color: colors.red,
                            draggable: true,
                            resizable: {
                                beforeStart: true,
                    ...
                    this.joinCalendarflagdate = true;
                }
            }
            else {
                this.events.push({
    ...
    CompetitionPageComponent.prototype.dayClicked = function (_a) {
        var date = _a.date, events = _a.events;
        if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_date_fns__["isSameMonth"])(date, this.viewDate)) {
            if ((__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_date_fns__["isSameDay"])(this.viewDate, date) && this.activeDayIsOpen === true) || events.length === 0) {
                this.activeDayIsOpen = false;
            }
            else {
                this.activeDayIsOpen = true;
    ...
    CompetitionPageComponent.prototype.eventTimesChanged = function (_a) {
    ...
    // calendar detail click
    CompetitionPageComponent.prototype.handleEvent = function (action, event) {
        var compete = null;
        this.modalData = { event: event, action: action };
        for (var i = 0; i < this.selectedCompetitions.length; i++) {
            if (this.selectedCompetitions[i].name === event.title) {
                compete = this.selectedCompetitions[i];
            }
        }
        var modalRef = this.modalService.open(__WEBPACK_IMPORTED_MODULE_6__app_detailed_app_detailed_competition_component__["a" /* DetailedCompetitionComponent */], { size: 'lg' });
        modalRef.componentInstance.competition = compete;
    };
    __decorate([
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_rank_app_rank_competition_component__ = __webpack_require__(1441);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_detailed_app_detailed_competition_component__ = __webpack_require__(1437);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__apex_services__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_participate_app_participate_competition_component__ = __webpack_require__(1440);
...
var CompetitionsComponent = /** @class */ (function () {
    function CompetitionsComponent(modalService, competitionSvc) {
        this.modalService = modalService;
        this.competitionSvc = competitionSvc;
    }
    CompetitionsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.competitionSvc.getCompetitions().subscribe(function (competitions) { return _this.competitions = competitions; });
    };
    CompetitionsComponent.prototype.onShowDetailedCompetition = function (competition, position) {
        var modalRef = this.modalService.open(__WEBPACK_IMPORTED_MODULE_3__app_detailed_app_detailed_competition_component__["a" /* DetailedCompetitionComponent */], { size: 'lg' });
        modalRef.componentInstance.competition = competition;
        modalRef.componentInstance.position = position;
    };
    CompetitionsComponent.prototype.onShowCompetitionRank = function (competition) {
        var modalRef = this.modalService.open(__WEBPACK_IMPORTED_MODULE_2__app_rank_app_rank_competition_component__["a" /* RankCompeteComponent */], { size: 'lg' });
        modalRef.componentInstance.competition = competition;
    };
    CompetitionsComponent.prototype.onParticipateCompetition = function (competition) {
        var _this = this;
        this.competitionSvc.participate(competition).subscribe(function (result) { });
        this.competitionSvc.realParticipate().subscribe(function (result) {
            if (result === 'success') {
                var modalRef = _this.modalService.open(__WEBPACK_IMPORTED_MODULE_5__app_participate_app_participate_competition_component__["a" /* ParticipateCompetitionComponent */], { size: 'lg' });
                modalRef.componentInstance.popupdetail = 'success';
            }
            else if (result === 'false') {
                var modalRef = _this.modalService.open(__WEBPACK_IMPORTED_MODULE_5__app_participate_app_participate_competition_component__["a" /* ParticipateCompetitionComponent */], { size: 'lg' });
    ...
    CompetitionsComponent.prototype.onCancelCompetition = function (competition) {
        this.competitionSvc.cancel(competition);
    };
    CompetitionsComponent.prototype.isParticipated = function (competition) {
        return this.competitionSvc.isParticipated(competition);
    };
    CompetitionsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__ng_bootstrap_ng_bootstrap__["b" /* NgbModal */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__ng_bootstrap_ng_bootstrap__["b" /* NgbModal */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4__apex_services__["k" /* CompetitionService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__apex_services__["k" /* CompetitionService */]) === "function" && _b || Object])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_detailed_app_detailed_competition_component__ = __webpack_require__(1437);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__apex_services__ = __webpack_require__(41);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MyCompetitionComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyCompetitionComponent = /** @class */ (function () {
    function MyCompetitionComponent(modalService, competitionSvc) {
        var _this = this;
        this.modalService = modalService;
        this.competitionSvc = competitionSvc;
    ...
    MyCompetitionComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.competitionSvc.getParticipatedCompetitions().subscribe(function (competitions) {
            _this.selectedCompetitions = competitions;
            _this.selectedCompetitions.forEach(function (c) {
                _this.events.push({
                    title: c.name,
                    ...
                    actions: [{
                            ...
                            onClick: function (_a) {
                                ...
                                _this.onCancelCompetition(_this.selectedCompetitions.find(function (_c) { return _c.name === event.title; }));
                            }
                        }]
                });
            });
    ...
    MyCompetitionComponent.prototype.dayClicked = function (_a) {
        var date = _a.date, events = _a.events;
    ...
    MyCompetitionComponent.prototype.onShowDetailedCompetition = function (competition) {
        var modalRef = this.modalService.open(__WEBPACK_IMPORTED_MODULE_4__app_detailed_app_detailed_competition_component__["a" /* DetailedCompetitionComponent */], { size: 'lg' });
        modalRef.componentInstance.competition = competition;
    };
    MyCompetitionComponent.prototype.onCancelCompetition = function (competition) {
        var _this = this;
        this.competitionSvc.cancel(competition);
        this.events = this.events.filter(function (e) { return e.title !== competition.name; });
        this.competitionSvc.getParticipatedCompetitions().subscribe(function (competitions) { return _this.selectedCompetitions = competitions; });
    };
    MyCompetitionComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-my-competition',
            template: __webpack_require__(1620),
            styles: [__webpack_require__(1560)]
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__ng_bootstrap_ng_bootstrap__["b" /* NgbModal */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__ng_bootstrap_ng_bootstrap__["b" /* NgbModal */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_5__apex_services__["k" /* CompetitionService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__apex_services__["k" /* CompetitionService */]) === "function" && _b || Object])
    ], MyCompetitionComponent);
    return MyCompetitionComponent;
    var _a, _b;
}());

//# sourceMappingURL=my-competition.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__competition_page_component__ = __webpack_require__(1490);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__competitions_competitions_component__ = __webpack_require__(1491);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__my_competition_my_competition_component__ = __webpack_require__(1492);
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_1__competition_page_component__["a" /* CompetitionPageComponent */],
        children: [
            { path: '', redirectTo: 'all', pathMatch: 'full' },
            { path: 'all', component: __WEBPACK_IMPORTED_MODULE_2__competitions_competitions_component__["a" /* CompetitionsComponent */] },
            { path: 'mycompetitions', component: __WEBPACK_IMPORTED_MODULE_3__my_competition_my_competition_component__["a" /* MyCompetitionComponent */] }
        ]
    }
];
var routing = __WEBPACK_IMPORTED_MODULE_0__angular_router__["c" /* RouterModule */].forChild(routes);
//# sourceMappingURL=competition-page.routing.js.map
...
// module
exports.push([module.i, ".competition-date {\n  font-weight: bold; }\n\n.rule {\n  border: 1px solid #dddddd;\n  height: 200px;\n  overflow: scroll; }\n\n.information {\n  border: 1px solid #dddddd; }\n\n.btn-position {\n  margin-left: 56%; }\n", ""]);
...
// module
exports.push([module.i, ".competition-time {\n  font-size: medium; }\n", ""]);
...
// module
exports.push([module.i, "h3 {\n  margin: 0 0 10px; }\n\npre {\n  background-color: #f5f5f5;\n  padding: 15px; }\n\n.ngbtabContent {\n  height: 680px; }\n\n.hotcompeteoutside {\n  float: left;\n  background-color: white;\n  border: #008dba; }\n\n.hotcompeteheader {\n  text-align: center; }\n\n.hotcompeteblock {\n  height: 600px;\n  float: left;\n  overflow: auto;\n  background-color: white;\n  border: #008dba; }\n\n.hotcompetedetailbutton {\n  width: 40%;\n  height: 10%; }\n\n.hotcompetejoinbutton {\n  width: 40%;\n  height: 10%; }\n\n.competeviewoutside {\n  float: left;\n  background-color: white;\n  border: #008dba; }\n\n.competeviewheader {\n  text-align: center; }\n\n.competeviewblock {\n  height: 600px;\n  float: left;\n  overflow: auto;\n  background-color: white;\n  border: #008dba; }\n\n.competeviewbutton {\n  width: 40%;\n  height: 10%; }\n\n.competeviewbutton {\n  width: 40%;\n  height: 10%; }\n\n.selectedcompeteoutside {\n  float: left;\n  background-color: white;\n  border: #008dba; }\n\n.selectedcompeteheader {\n  text-align: center; }\n\n.selectedcompeteblock {\n  height: 600px;\n  float: left;\n  overflow: auto;\n  background-color: white;\n  border: #008dba; }\n\n.selectedcompetecancelbutton {\n  width: 40%;\n  height: 10%; }\n\n.calenderoutside {\n  float: left;\n  background-color: white;\n  border: #008dba; }\n\n.calenderheader {\n  text-align: center; }\n\n.calenderblock {\n  height: 650px;\n  float: left;\n  overflow: auto;\n  background-color: white;\n  border: #008dba; }\n\n.viewDate {\n  margin-left: 90px; }\n", ""]);
...
module.exports = "<div class=\"modal-header\" >\n  <h4 class=\"modal-title\" translate>{{ 'competition.detail_competes' }}</h4>\n  <button type=\"button\" class=\"close\" aria-label=\"Close\" (click)=\"activeModal.dismiss('Cross click')\">\n    <span aria-hidden=\"true\">&times;</span>\n  </button>\n</div>\n<div class=\"modal-body\">\n  <div class=\"card-header\">{{ competition.name }}</div>\n  <table class=\"table table-bordered\">\n    <tbody>\n    <tr>\n      <th translate>{{ 'competition.organizer' }}</th>\n      <td>{{ competition.organizer }}</td>\n    </tr>\n    <tr>\n      <th translate>{{ 'competition.co_organizer' }}</th>\n      <td>{{ competition.coOrganizer }}</td>\n    </tr>\n    <tr>\n      <th translate>{{ 'competition.invite' }}</th>\n      <td>{{ competition.invitees }}</td>\n    </tr>\n    <tr>\n      <th translate>{{ 'competition.date' }}</th>\n      <td>{{ competition.startDate }} ~ {{ competition.endDate }}</td>\n    </tr>\n    <tr>\n      <th translate>{{ 'competition.schedule' }}</th>\n      <td>\n        <div class=\"competition-date\" *ngFor=\"let row of competition.schedule\">{{ row.title }}: {{ row.date }}<br></div>\n      </td>\n    </tr>\n    <tr *ngIf=\"competition.awards\">\n      <th translate>{{ 'competition.content' }}</th>\n      <td >\n        <div class=\"competition-date\" *ngFor=\"let row of competition.awards\">{{ row.date }}: {{ row.title }} <br></div>\n      </td>\n    </tr>\n    </tbody>\n  </table>\n\n</div>\n<div class=\"modal-body\">\n  <div class=\"card-header\" translate>{{ 'competition.rule' }}</div>\n  <div class=\"rounded p-2 rule\">\n    <pre>\n  競賽規則:\n  1.選擇『 10-20 檔』上市或上櫃之個股（包含不動產證券以及 ETF、TDR ）\n    、權證、指數期貨(台指、金指、電指、小台指、非金電、櫃買、50期，不含債券期貨)\n    、以及指數選擇權(本次交易競賽無期貨與選擇權盤後交易)\n    ，開放現貨市場信用交易(融資融券)；每日總持有檔數必須維持在此規定範圍內。\n  2.持有部位價值須達每日總資產價值『七成 ( 含 ) 』以上；\n  3.現貨(含融資融券)持有部位須達每日總資產價值『三成(含)』以上；\n  4.期貨持有部位須達每日總資產價值三成以上；\n  5.選擇權部位不得超過一成\n\n  違反規定:\n  以下之規定於每日收盤後檢查，僅以實際持股計算，掛單部位不予計算。\n\n  1.每日追蹤『投資種類 ( 標的 ) 』有無符合『競賽規則』規定。違反規定者，扣分方式如下：\n   (1)原『總報酬率』為 12% ，若違反一項規定扣減1%，結算後之『總報酬率』為 11% ；\n   (2)違反規定扣減之報酬率採累計計算；\n   (3)每天最多以懲處 5% 為上限。\n  2.當日下單上限筆數 200 筆。\n  3.違反規則，情節嚴重者，主辦單位得取消其參賽資格。\n  4.部位建立期間，不進行違規懲處。\n    </pre>\n  </div>\n</div>\n<div class=\"modal-body\">\n  <div class=\"card-header\" translate>{{ 'competition.contact' }}</div>\n  <div class=\"rounded p-2 information\">\n    <pre>\n寶碩財務科技股份有限公司:<a href=\"http://www.apex.com.tw/apex\">http://www.apex.com.tw/apex</a>\n電話:(02)8791-9799#8712\n聯絡窗口:fincloudcenter@mail.apex.com.tw\n    </pre>\n  </div>\n</div>\n\n<button class=\"btn btn-secondary col-sm-5 btn-position\" *ngIf=\"position == 'right' \" (click)=\"onParticipateCompetition(competition);activeModal.dismiss('Cross click')\" [disabled]=\"true\" translate>{{ 'common.button.participate' }}</button>\n<br><br>\n\n\n\n"
...
module.exports = "<div class=\"modal-header\" >\n  <h4 class=\"modal-title\" translate>{{ 'common.content.important_msg' }}</h4>\n  <button type=\"button\" class=\"close\" aria-label=\"Close\" (click)=\"activeModal.dismiss('Cross click')\">\n    <span aria-hidden=\"true\">&times;</span>\n  </button>\n</div>\n<div class=\"modal-body\">\n  <div *ngIf=\"popupdetail == 'success' \" translate>{{ 'competition.success_participate_first' }}</div>\n  <div *ngIf=\"popupdetail == 'success' \" class=\"text-danger\" translate>{{ 'competition.success_participate_second' }}</div>\n  <div *ngIf=\"popupdetail == 'false' \" translate>{{ 'competition.false_participate' }}</div>\n  <div *ngIf=\"popupdetail == 'full' \" translate>{{ 'competition.full_participate' }}</div>\n</div>\n<button class=\"btn btn-secondary w-25 offset-4\" (click)=\"activeModal.dismiss('Cross click')\" translate>{{ 'competition.confirm' }}</button>\n<br><br>\n"
...
module.exports = "<div class=\"modal-header\" >\n  <h4 class=\"modal-title w-100\" translate>{{ 'competition.detail_competes' }}\n    <span class=\"competition-time float-right\" translate>{{ 'competition.time' }}</span>\n  </h4>\n  <button type=\"button\" class=\"close\" aria-label=\"Close\" (click)=\"activeModal.dismiss('Cross click')\">\n    <span aria-hidden=\"true\">&times;</span>\n  </button>\n</div>\n<div class=\"modal-body\">\n  <table class=\"table table-bordered\">\n    <tbody>\n    <tr>\n      <th colspan=\"2\">{{ competition.name }}</th>\n    </tr>\n    <tr>\n      <th translate>{{ 'competition.organizer' }}</th>\n      <td>{{ competition.organizer }}</td>\n    </tr>\n    <tr>\n      <th translate>{{ 'competition.co_organizer' }}</th>\n      <td>{{ competition.coOrganizer }}</td>\n    </tr>\n    <tr>\n      <th translate>{{ 'competition.date' }}</th>\n      <td>{{ competition.startDate }} ~ {{ competition.endDate }}</td>\n    </tr>\n    </tbody>\n  </table>\n  <!--<table class=\"table table-bordered\" >-->\n    <!--<tbody>-->\n    <!--<tr>-->\n      <!--<th colspan=\"3\" translate>{{ 'competition.rank' }}</th>-->\n    <!--</tr>-->\n    <!--<tr>-->\n      <!--<th class=\"text-center\" translate>{{ 'competition.rank_sort' }}</th>-->\n      <!--<th class=\"text-center\" translate>{{ 'competition.rank_name' }}</th>-->\n      <!--<th class=\"text-center\" translate>{{ 'competition.rank_remuneration' }}</th>-->\n    <!--</tr>-->\n    <!--<tr  class=\"text-center\" *ngFor=\"let row of competition.rank \">-->\n      <!--<td>{{ row.id }}</td>-->\n      <!--<td>{{ row.name }}</td>-->\n      <!--<td>-->\n        <!--<span [class.text-danger]=\"row.price > 0\" [class.text-success]=\"row.price < 0\">{{ row.price | currency:'NTD':true:'.0' | replace:'NTD':'' }}</span>-->\n        <!--(<span [class.text-danger]=\"row.price > 0\" [class.text-success]=\"row.price < 0\">{{ row.percent }}</span>)-->\n      <!--</td>-->\n    <!--</tr>-->\n    <!--</tbody>-->\n  <!--</table>-->\n  <table class=\"table table-bordered\">\n    <tbody>\n      <tr>\n        <th colspan=\"3\" translate>{{ 'competition.rank' }}</th>\n      </tr>\n      <tr>\n        <div class=\"row\">\n          <span class=\"text-center\">\n            <!--<div>{{ competition.rank[0].name }}</div>-->\n            <img src=\"./assets/images/competes/first.png\" alt=\"first\">\n          </span>\n          <span class=\"text-center\">\n            <!--<div>{{ competition.rank[1].name }}</div>-->\n            <img src=\"./assets/images/competes/second.png\" alt=\"second\">\n          </span>\n          <span class=\"text-center\">\n            <!--<div>{{ competition.rank[2].name }}</div>-->\n            <img src=\"./assets/images/competes/third.png\" alt=\"third\">\n          </span>\n        </div>\n      </tr>\n      <tr>\n      </tr>\n      <tr>\n      </tr>\n    </tbody>\n  </table>\n\n</div>\n\n"
...
module.exports = "<div class=\"container\">\n  <div class=\"row\">\n    <div class=\"col-md-6\">\n      <div class=\"card\">\n        <div class=\"card-header\" translate>{{ 'competition.competing' }}</div>\n        <div class=\"card-block\" *ngFor=\"let c of competitions\">\n          <div class=\"card\">\n            <div class=\"card-header\">{{ c.name }}</div>\n            <div class=\"card-block\">\n              <div>\n                <span translate>{{ 'competition.organizer' }}</span>:\n                <span>{{ c.organizer }}</span>\n              </div>\n              <div>\n                <span translate>{{ 'competition.co_organizer' }}</span>:\n                <span>{{ c.coOrganizer }}</span>\n              </div>\n              <div>\n                <span translate>{{ 'competition.invite' }}</span>:\n                <span>{{ c.invitees }}</span>\n              </div>\n              <div>\n                <span translate>{{ 'competition.date' }}</span>:\n                <span>{{ c.startDate }} ~ {{ c.endDate }}</span>\n              </div>\n              <div class=\"btn-group w-100\">\n                <button class=\"btn btn-secondary w-50\" (click)=\"onShowDetailedCompetition(c, 'left')\" translate>{{ 'common.button.detail' }}</button>\n                <button class=\"btn btn-secondary w-50\" (click)=\"onShowCompetitionRank(c)\" translate>{{ 'competition.rank' }}</button>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n    <div class=\"col-md-6\">\n      <div class=\"card\">\n        <div class=\"card-header\" translate>{{ 'competition.start_signup' }}</div>\n        <div class=\"card-block\" *ngFor=\"let c of competitions\">\n          <div class=\"card\">\n            <div class=\"card-header\">{{ c.name }}</div>\n            <div class=\"card-block\">\n              <div>\n                <span translate>{{ 'competition.organizer' }}</span>:\n                <span>{{ c.organizer }}</span>\n              </div>\n              <div>\n                <span translate>{{ 'competition.co_organizer' }}</span>:\n                <span>{{ c.coOrganizer }}</span>\n              </div>\n              <div>\n                <span translate>{{ 'competition.invite' }}</span>:\n                <span>{{ c.invitees }}</span>\n              </div>\n              <div>\n                <span translate>{{ 'competition.date' }}</span>:\n                <span>{{ c.startDate }} ~ {{ c.endDate }}</span>\n              </div>\n              <div class=\"btn-group w-100\">\n                <button class=\"btn btn-secondary w-50\" (click)=\"onShowDetailedCompetition(c, 'right')\" translate>{{ 'common.button.detail' }}</button>\n                <button class=\"btn btn-secondary w-50\" (click)=\"onParticipateCompetition(c)\" [disabled]=\"true\" translate>{{ 'common.button.participate' }}</button>\n                <!--<button class=\"btn btn-danger w-50\" *ngIf=\"isParticipated(c)\" (click)=\"onCancelCompetition(c)\" translate>{{ 'common.button.cancel' }}</button>-->\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n"
...
module.exports = "<div class=\"container\">\n  <div class=\"row\">\n    <div class=\"col-md-5\">\n      <div class=\"card\">\n        <div class=\"card-header\" translate>{{ 'competition.competing' }}</div>\n        <div class=\"card-block\" *ngFor=\"let c of selectedCompetitions\">\n          <div class=\"card\">\n            <div class=\"card-header\">{{ c.name }}</div>\n            <div class=\"card-block\">\n              <div>\n                <span translate>{{ 'competition.organizer' }}</span>:\n                <span>{{ c.organizer }}</span>\n              </div>\n              <div>\n                <span translate>{{ 'competition.co_organizer' }}</span>:\n                <span>{{ c.coOrganizer }}</span>\n              </div>\n              <div>\n                <span translate>{{ 'competition.invite' }}</span>:\n                <span>{{ c.invitees }}</span>\n              </div>\n              <div>\n                <span translate>{{ 'competition.date' }}</span>:\n                <span>{{ c.startDate }} ~ {{ c.endDate }}</span>\n              </div>\n              <div class=\"btn-group w-100\">\n                <button class=\"btn btn-secondary w-50\" (click)=\"onShowDetailedCompetition(c)\" translate>{{ 'common.button.detail' }}</button>\n                <button class=\"btn btn-danger w-50\" (click)=\"onCancelCompetition(c)\" translate>{{ 'common.button.cancel' }}</button>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n    <div class=\"col-md-7\">\n      <div class=\"card\">\n        <div class=\"card-header\" translate>{{ 'competition.calender_title' }}</div>\n        <div class=\"card-block\">\n          <div class=\"row\">\n            <div class=\"col-md-4\">\n              <div class=\"btn btn-link\" mwlCalendarPreviousView [view]=\"'month'\" [(viewDate)]=\"viewDate\"><i class=\"fa fa-chevron-left\"></i></div>\n            </div>\n            <div class=\"col-md-4 h3 m-0\">{{ viewDate | calendarDate:('monthViewTitle'):locale }}</div>\n            <div class=\"col-md-4\">\n              <div class=\"btn btn-link float-right\" mwlCalendarNextView [view]=\"'month'\" [(viewDate)]=\"viewDate\"><i class=\"fa fa-chevron-right\"></i></div>\n            </div>\n          </div>\n          <mwl-calendar-month-view\n             [viewDate]=\"viewDate\"\n             [events]=\"events\"\n             [locale]=\"locale\"\n             [activeDayIsOpen]=\"activeDayIsOpen\"\n             (dayClicked)=\"dayClicked($event.day)\">\n          </mwl-calendar-month-view>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n"
